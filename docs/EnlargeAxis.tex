...
These lowercase letters are affected by the Enlarge axis (note that all composite characters (e.g. \textex{á}, \textex{ü})
based on these are also affected):
\begin{multicols}{8}
  a
  ...
  {\addfontfeature{Language=Icelandic}ð}

  {\addfontfeature{Language=English}ð}
  ...
  {\addfontfeature{Language=Icelandic}þ}

  {\addfontfeature{Language=English}þ}

  {\addfontfeature{Language=Icelandic}ꝥ}

  {\addfontfeature{Language=English}ꝥ}

  {\addfontfeature{Language=Icelandic,CharacterVariant=66}ꝥ}

  {\addfontfeature{Language=English,CharacterVariant=66}ꝥ}
