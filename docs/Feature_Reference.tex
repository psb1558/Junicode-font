...
%\newfontface\semibold{Junicode Two Beta Semibold}
...
\huge \centering the font for medievalists \\[1cm]
 ...
 \huge\centering {\stditalic specimens and feature reference} \\[1ex]
...
\subsection*{Greek}
{\regular\addfontfeature{Language=Greek} βίβλος
...
\noindent\textit{\addfontfeature{Language=Greek}βίβλος
γενέσεως ἰησοῦ χριστοῦ υἱοῦ δαυὶδ
υἱοῦ ἀβραάμ.
ἀβραὰμ
ἐγέννησεν τὸν ἰσαάκ, ἰσαὰκ δὲ ἐγέννησεν
...
\textLetterExample{ᾬ}. If you
prefer a different result, place U+034F \textUName{combining grapheme joiner} somewhere
