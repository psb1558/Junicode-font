...
to think of the differences is that, while cvNN features live in a text's markup, tags are part of the text. For detailed instructions on how to use tags and a list of them, see the document tag\_key.pdf.
