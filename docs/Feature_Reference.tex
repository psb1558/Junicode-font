...
%      {Size={21.6-},     RawFeature={axis={wght=300,wdth=100}}}
%    },
%  },
%  ItalicFeatures={
%    SizeFeatures={
...
%      {Size={21.6-},     RawFeature={axis={wght=300,wdth=98}}}
%    },
%  },
%  BoldFeatures={
%    SizeFeatures={
...
%\setfontface\regular{JunicodeTwoBetaVF-Roman.otf}[
%  SizeFeatures={
...
%\setfontface\narrow{JunicodeTwoBetaVF-Roman.otf}[
%  SizeFeatures={
...
%    {Size={22-},       RawFeature={axis={wght=350,wdth=75}}}
%  },
%]
\newfontface\seminarrow{Junicode Two Beta SemiCondensed}
%\setfontface\seminarrow{JunicodeTwoBetaVF-Roman.otf}[
%  SizeFeatures={
...
%    {Size={22-},       RawFeature={axis={wght=350,wdth=87.5}}}
%  },
%]
\newfontface\seminarrowlight{Junicode Two Beta SemiCondensed Light}
%\setfontface\seminarrowlight{JunicodeTwoBetaVF-Roman.otf}[
%  SizeFeatures={
%    {Size={-8.5},      RawFeature={axis={wght=350,wdth=87.5}}},
%    {Size={8.5-11},    RawFeature={axis={wght=325,wdth=87.5}}},
%    {Size={11-22},     RawFeature={axis={wght=300,wdth=87.5}}},
%    {Size={22-},       RawFeature={axis={wght=300,wdth=87.5}}}
%  },
%]
\newfontface\semiwide{Junicode Two Beta SemiExpanded}
%\setfontface\semiwide{JunicodeTwoBetaVF-Roman.otf}[
%  SizeFeatures={
...
%    {Size={22-},       RawFeature={axis={wght=350,wdth=112.5}}}
%  },
%]
\newfontface\wide{Junicode Two Beta Expanded}
%\setfontface\wide{JunicodeTwoBetaVF-Roman.otf}[
%  SizeFeatures={
...
%    {Size={22-},       RawFeature={axis={wght=350,wdth=125}}}
%  },
%]
\newfontface\light{Junicode Two Beta Light}
%\setfontface\light{JunicodeTwoBetaVF-Roman.otf}[
%  SizeFeatures={
%    {Size={-8.5},      RawFeature={axis={wght=350,wdth=120}}},
%    {Size={8.5-11},    RawFeature={axis={wght=325,wdth=115}}},
%    {Size={11-22},     RawFeature={axis={wght=300,wdth=112.5}}},
%    {Size={22-},       RawFeature={axis={wght=300,wdth=100}}}
%  },
%]
\newfontface\medium{Junicode Two Beta SemiExpanded Medium}
%\setfontface\medium{JunicodeTwoBetaVF-Roman.otf}[
%  SizeFeatures={
%    {Size={-8.5},      RawFeature={axis={wght=550,wdth=120}}},
...
%\setfontface\semicondsemibold{JunicodeTwoBetaVF-Roman.otf}[
%  SizeFeatures={
...
%\setfontface\condbold{JunicodeTwoBetaVF-Roman.otf}[
%  SizeFeatures={
%    {Size={-8.5},      RawFeature={axis={wght=700,wdth=75}}},
%    {Size={8.5-11},    RawFeature={axis={wght=700,wdth=75}}},
...
%\setfontface\stditalic{JunicodeTwoBetaVF-Italic.otf}[
%  SizeFeatures={
%    {Size={-8.5},      RawFeature={axis={wght=400,wdth=100}}},
%    {Size={8.5-11},    RawFeature={axis={wght=400,wdth=100}}},
%    {Size={11-22},     RawFeature={axis={wght=400,wdth=100}}},
...
%\setfontface\semiconditalic{JunicodeTwoBetaVF-Italic.otf}[
%  SizeFeatures={
...
{\addfontfeature{Language=Icelandic}\medium Um haustit sendi Mǫrðr Valgarðsson orð at Gunnarr myndi vera einn heimi, en
...
the modern Icelandic (þð), and in ancient
...
{\addfontfeature{Numbers=SlashedZero}0 \otab{0} \lprop{0} \oprop{0}. Includes superscripts, subscripts, and
fractions formed with \textSourceText{frac}:
\sups{0~\oprop{0}}~\subs{0~\oprop{0}} \addfontfeature{Fractions=On} 10/30}.
...
where available. Variants in \cvc{red} are also available via \textSourceText{ss06} “Enlarged Minuscules.”
...
\centering{D} &
\centering{cv07} &
{1=\cvd{7}{D}, 2=\cvd[1]{7}{D}, \cvc{3=\cvd[2]{7}{D}, 4=\cvd[3]{7}{D}}}\\\hline
\centering{d} &
\centering{cv08} &
...
\centering{i} &
\centering{cv18} &
{1=\cvd{18}{i}, 2=\cvd[1]{18}{i}, 3=\cvd[2]{18}{i}, \cvc{4=\cvd[3]{18}{i}}}\\\hline
\centering{J} &
\centering{cv19} &
...
\centering{k} &
\centering{cv22} &
{1=\cvd{22}{k}, 2=\cvd[1]{22}{k}, 3=\cvd[2]{22}{k}, 4=\cvd[3]{22}{k}, \cvc{4=\cvd[3]{22}{k}}}\\\hline
\centering{L} &
\centering{cv23} &
{\cvc{\cvd{23}{L}}}\\\hline
\centering{l} &
...
\centering{Q} &
\centering{cv33} &
{1=\cvd{33}{Q}, 2=\cvd[1]{33}{Q}, \cvc{3=\cvd[2]{33}{Q}},
\textit{4=\cvd[3]{33}{Q} (italics only)}}\\\hline
\centering{q} &
\centering{cv34} &
{1=\cvd{34}{q}, \cvc{2=\cvd[1]{34}{q}}}\\\hline
\centering{R} &
\centering{cv35} &
{1=\cvd{35}{R}, \cvc{2=\cvd[1]{35}{R}}}\\\hline
\centering{r} &
\centering{cv36} &
...
capitals, if you prefer, the \textit{prosgegrammeni} (\unic{U+1FBE}).
...
and combining marks ◌ͣ (\unic{U+0363}), ◌ͤ (\unic{U+0364}), \cvd[17]{84}{◌͏̄}
(\unic{U+0304}\slash\textSourceText{cv84[18]}), ◌ͦ (\unic{U+0366}), ◌ͬ (\unic{U+036C}), ◌ᷢ (\unic{U+1DE2}),
◌ͭ (\unic{U+036D}), ◌ͮ (\unic{U+036E}), ◌ᷦ (\unic{U+1DE6}) and \cvd[21]{84}{◌͏̄}
(\unic{U+0304}/\textSourceText{cv84[21]}). Instead of being positioned above ascender height as usual (e.g.
...
{\addfontfeature{StylisticSet=20}bͦ, ꝺᷦ, \cvd[17]{84}{h̄}, kͤ, {\th}ͭ, ðᷢ}.
...
%\subsection[51. cv90 {}-- Variants of ◌̄  (\unic{U+0304}, combining macron)]{\stepcounter{Feature}{\theFeature}.
%\textSourceText{cv}\textSourceText{90} -- Variants of ◌̄ (\unic{U+0304}, combining macron)}
%1=\cvd{90}{◌̄}, 2=\cvd[1]{90}{◌̄}. These are used for abbreviations in manuscripts and
%early printed books.
%
\subsection[52. cv91 {}-- Variants of short horizontal stroke (U+0335)]{\stepcounter{Feature}{\theFeature}.
\textSourceText{cv91} -- Variants of short horizontal stroke (\unic{U+0335})}
