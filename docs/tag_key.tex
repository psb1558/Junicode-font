...
\usepackage[english,icelandic,latin]{babel}
...
\newcommand{\textex}[1]{{\color{myRed}#1}}
...
\begin{document}
\pagestyle{fancy}
\addfontfeature{Script=Latin,Language=English}
\begin{titlepage}
\huge\noindent
{\color{myRed}}\\[5cm]
...
\huge \centering the font for medievalists \\[1cm]
 ...
 \huge\centering {\stditalic Entering characters with tags} \\[1ex]
...
you can enter these using character entities (e.g. \textex{\&\#xE0073;} for \textex{\&\_\_s;});
along the same lines, you can use the \textex{{\textbackslash}char} command
(e.g. \textex{{\textbackslash}char{\textquotedbl}0E0073}) when
...
example, typing \textex{\&\_\_6\char"200C;} will yield the tag \textex{\&\_\_6;}.
...
entering characters with tags}
\fancyhead[CO]{\scshape\color{myRed} {%
entering characters with tags}\hspace{10pt}{\addfontfeatures{Numbers=OldStyle}\thepage}}

\noindent Then apply the OpenType feature ss10 (Stylistic Set 10) to the passage or passages containing the tags or, if tags occur
throughout, to the whole document. The tags will disappear and the preceding characters (the base characters) will be
transformed.

For variants of the combining macron (U+0304) and perhaps other combining marks, it will often be necessary to place the
\ctosc{COMBINING GRAPHEME JOINER} (U+034F) between the macron and the base character that precedes it. This will prevent
...
throughout the text, in a particular passage (for example, a block quotation), or in a style. A tag sequence may be
preferable for isolated forms or to override an OpenType feature.
...
\begin{center}
  ...
  \begin{supertabular}{|m{13mm}|m{72mm}|}
    ...
    \nuni{red} & Characters without code points\\\hline
  \end{supertabular}
\end{center}
...
\textex{T\&\_\_i;\&\_\_n;}, but if entered as \textex{U+A786} it may or may not be searchable as T,
...
\arraybslash {\narrow Punctus interrogativus horizontal tilde / F1E8}\\\hline
\mufi{period} &
{.\&\_\_1;\&\_\_6;} &
{\restag{.\char"0E0031\char"0E0036}} &
\arraybslash {\narrow Punctus interrogativus lemniskate / F1F1}\\\hline
\mufi{period} &
{.\&\_\_1;\&\_\_7;} &
...
\arraybslash {\narrow Combining ligature o r rotunda / F03E}\\\hline
\mufi{U+0304} &
{\char"25CC\char"0304\&\_\_2;\&\_\_9;} &
{\restag{\char"25CC\char"0304\char"0E0032\char"0E0039}} &
\arraybslash {\narrow Combining ligature letter o rum / F03F}\\\hline
\nuni{U+0304} &
...
\arraybslash {\narrow l with high stroke ending with flourish / F000F}\\\hline
\mufi{M} &
{M\&\_\_u;\&\_\_d;} &
...
\arraybslash {\narrow x with two diagonal strokes (lower right) / E8CE}\\\hline
\mufi{Y} &
{Y\&\_\_s;\&\_\_d;} &
\restag{Y\char"0E0073\char"0E0064} &
\arraybslash {\narrow Y with diagonal stroke (Hymnus abbrev) / E8DB}\\\hline
\nuni{Y} &
{Y\&\_\_e;\&\_\_n;} &
...
\arraybslash {\narrow Enlarged minuscule ao with smaller o / EAF2}\\\hline
\mufi{U+A735} &
...
\nuni{U+0119} &
\restag{ę\char"0307\char"0301\&\_\_c;\&\_\_e;} &
\restag{ę\char"0307\char"0301\char"0E0063\char"0E0065} &
\arraybslash e with dot, acute, and centered ogonek\\\hline
\nuni{U+0119} &
{ę\char"0307\char"0301\&\_\_s;\&\_\_t;} &
...
\arraybslash {\narrow Old Polish o with broken slash / F0011}\\\hline
\opua{U+A7C1} &
{\prob\&\_\_a;\&\_\_2;} &
{\prob\restag{\char"0A7C1\char"0E0061\char"0E0032}} &
\arraybslash {\narrow Old Polish o with short slash / F0012}\\\hline
\opua{U+A7C1} &
{\prob\&\_\_a;\&\_\_3;} &
{\prob\restag{\char"0A7C1\char"0E0061\char"0E0033}} &
\arraybslash {\narrow Old Polish o with lower left slash / F0013}\\\hline
\opua{U+A7C1} &
{\prob\&\_\_a;\&\_\_4;} &
{\prob\restag{\char"0A7C1\char"0E0061\char"0E0034}} &
\arraybslash {\narrow Old Polish o with upper right slash / F0014}\\\hline
\mufi{U+A765} &
...
\arraybslash \ {\narrow thorn with stroke with different slant / F149}\\\hline
\nuni{U+A765/ENG} &
...
\arraybslash {\narrow Colon with middle comma positura / F1E5}\\\hline
\mufi{semicolon} &
{;\&\_\_a;\&\_\_4;} &
...
\nuni{U+0308} &
{\char"25CC\&\_\_d;\&\_\_i;} &
\restag{\char"25CC\char"0E0064\char"0E0069} &
\arraybslash Combining diagonal dieresis\\\hline
\mufi{U+0305} &
